...
enum class Pattern(
    ...
    HUMANE_DESIGN(6, R.drawable.button_drawer_3, R.drawable.gratification_image, R.string.content_humane, R.string.title_humane),
    SIMPLE_ACCESS(7, R.drawable.button_drawer_1, R.drawable.gratification_image, R.string.content_access, R.string.title_access),
    BOTTOM(8, R.drawable.button_drawer_2, R.drawable.gratification_image, R.string.content_bottom, R.string.title_bottom),
    INFINITE_NAV(9, R.drawable.button_drawer_3, R.drawable.gratification_image, R.string.content_nav, R.string.title_nav)
    ;
